...
#ifndef VIBOFCHAIN_CHAINPARAMS_H
#define VIBOFCHAIN_CHAINPARAMS_H
 ...
 * VibofChain system. There are three: the main network on which people trade goods
...
#endif // VIBOFCHAIN_CHAINPARAMS_H
