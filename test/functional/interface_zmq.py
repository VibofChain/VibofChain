...
from test_framework.test_framework import VibofChainTestFramework, SkipTest
...
class ZMQTest (VibofChainTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that vibofchain has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("vibofchaind has not been built with zmq enabled.")
