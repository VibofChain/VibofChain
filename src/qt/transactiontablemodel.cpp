...
{
    columns[Amount] = VibofChainUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
QString TransactionTableModel::formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed, VibofChainUnits::SeparatorStyle separators) const
{
    QString str;
    switch(wtx->type) {
        case TransactionRecord::Issue:
        ...
        default:
            {
            str = VibofChainUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->credit + wtx->debit,
                                             false, separators);
            } break;
    }
    if (showUnconfirmed) {
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::DisplayRole:
        ...
        case Amount:
            return formatTxAmount(rec, true, VibofChainUnits::separatorAlways);
        case TokenName:
            return QString::fromStdString(rec->tokenName);
        }
        break;
    ...
    case TxPlainTextRole:
        {
            ...
            details.append(formatTxAmount(rec, false, VibofChainUnits::separatorNever));
            return details;
        }
    case ConfirmedRole:
    ...
    case FormattedAmountRole:
        ...
        return formatTxAmount(rec, false, VibofChainUnits::separatorNever);
    case TokenNameRole:
        {
            QString tokenName;
...
QVariant TransactionTableModel::headerData(int section, Qt::Orientation orientation, int role) const
{
    if(orientation == Qt::Horizontal)
    {
        ...
        } else if (role == Qt::ToolTipRole)
        {
            ...
            case TokenName:
                return tr("The token (or VBC) removed or added to balance.");
            }
        }
    }
    return QVariant();
