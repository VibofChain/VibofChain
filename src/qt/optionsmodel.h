...
#ifndef VIBOFCHAIN_QT_OPTIONSMODEL_H
#define VIBOFCHAIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for VibofChain client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // VibofChainUnits::Unit
...
#endif // VIBOFCHAIN_QT_OPTIONSMODEL_H
