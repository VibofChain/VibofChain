...
#ifndef VIBOFCHAIN_QT_VIBOFCHAINGUI_H
#define VIBOFCHAIN_QT_VIBOFCHAINGUI_H
...
/**
  VibofChain GUI main class. This class represents the main window of the VibofChain UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class VibofChainGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit VibofChainGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~VibofChainGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a vibofchain wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // VIBOFCHAIN_QT_VIBOFCHAINGUI_H
