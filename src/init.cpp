 ...
 * between vibofchaind, and vibofchain-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("vibofchain-shutoff");
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), VIBOFCHAIN_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/VibofChain/VibofChain>";
    const std::string URL_WEBSITE = "<https://vbc.network>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("vibofchain-loadblk");
...
/** Sanity checks
 *  Ensure that VibofChain is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("VibofChain version %s\n", FormatFullVersion());
}
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", VIBOFCHAIN_CONF_FILENAME)).string());
