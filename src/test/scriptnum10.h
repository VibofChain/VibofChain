...
#ifndef VIBOFCHAIN_TEST_SCRIPTNUM10_H
#define VIBOFCHAIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from VibofChain Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // VIBOFCHAIN_TEST_BIGNUM_H
