...
class AssetTest(VibofChainTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("VIBOFCHAIN1", 1000)
        n0.issue("VIBOFCHAIN2", 1000)
        n0.issue("VIBOFCHAIN3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="VIBOFCHAIN*", verbose=False, count=2, start=-2)
        ...
        vibofchain_assets = n0.listassets(asset="VIBOFCHAIN*", verbose=False, count=2, start=-2)
        assert_equal(len(vibofchain_assets), 2)
        assert_equal(vibofchain_assets[0], "VIBOFCHAIN2")
        assert_equal(vibofchain_assets[1], "VIBOFCHAIN3")
        self.sync_all()
