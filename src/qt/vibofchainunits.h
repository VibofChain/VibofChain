...
#ifndef VIBOFCHAIN_QT_VIBOFCHAINUNITS_H
#define VIBOFCHAIN_QT_VIBOFCHAINUNITS_H
...
/** VibofChain unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class VibofChainUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit VibofChainUnits(QObject *parent);

    /** VibofChain units.
      @note Source: https://en.vibofchain.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        VBC,
...
typedef VibofChainUnits::Unit VibofChainUnit;

#endif // VIBOFCHAIN_QT_VIBOFCHAINUNITS_H
