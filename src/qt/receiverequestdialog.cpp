...
#include "config/vibofchain-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatVibofChainURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + VibofChainUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatVibofChainURI(info));
}
