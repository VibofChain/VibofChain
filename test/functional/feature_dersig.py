...
class BIP66Test(VibofChainTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # vibofchaind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and vibofchaind produces more specific reject
            # reasons.
