...
class TxnMallTest(VibofChainTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 VBC:
        ...
        # First: use raw transaction API to send 1240 VBC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 VBC coin each
        ...
        # Node0's balance should be starting balance, plus 50VBC for another
        ...
        # Node0's total balance should be starting balance, plus 100VBC for 
