...
#ifndef VIBOFCHAIN_SCRIPT_SCRIPT_H
#define VIBOFCHAIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, VibofChain always counted CHECKMULTISIGs
...
#endif // VIBOFCHAIN_SCRIPT_SCRIPT_H
