...
#ifndef VIBOFCHAIN_WALLET_WALLET_H
#define VIBOFCHAIN_WALLET_WALLET_H
...
public:
     ...
     * on this vibofchain node, and set to 0 for transactions that were created
...
public:
    ...
    void AvailableCoinsAll(std::vector<COutput>& vCoins, std::map<std::string, std::vector<COutput> >& mapTokenCoins,
                            bool fGetVBC = true, bool fOnlyTokens = false,
    ...
    /**
     * Helper function that calls AvailableCoinsAll, used to receive all coins, Tokens and VBC
     */
...
#endif // VIBOFCHAIN_WALLET_WALLET_H
