...
#ifndef VIBOFCHAIN_QT_RECEIVECOINSDIALOG_H
#define VIBOFCHAIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of VBC */
...
#endif // VIBOFCHAIN_QT_RECEIVECOINSDIALOG_H
