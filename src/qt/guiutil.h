...
#ifndef VIBOFCHAIN_QT_GUIUTIL_H
#define VIBOFCHAIN_QT_GUIUTIL_H
...
/** Utility functions used by the VibofChain Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "vibofchain:" URI into recipient object, return true on successful parsing
