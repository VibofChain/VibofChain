...
#include "qt/vibofchainamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<VibofChainAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_vibofchain-qt -platform xcb      # Linux
//     src/qt/test/test_vibofchain-qt -platform windows  # Windows
//     src/qt/test/test_vibofchain-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = VibofChainUnits::formatWithUnit(unit, balance, false, VibofChainUnits::separatorAlways);
    ...
    // Amount input
    VibofChainAmountField* amountInput = receiveCoinsDialog.findChild<VibofChainAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: vibofchain:")) != -1);
