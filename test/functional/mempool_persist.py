...
By default, vibofchaind will dump mempool on shutdown and
...
class MempoolPersistTest(VibofChainTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give vibofchaind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent vibofchaind from writing mempool.dat to disk. Verify that `savemempool` fails")
