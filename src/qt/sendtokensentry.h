...
#ifndef VIBOFCHAIN_QT_SENDTOKENSENTRY_H
#define VIBOFCHAIN_QT_SENDTOKENSENTRY_H
...
/**
 * A single entry in the dialog for sending VBC.
...
#endif // VIBOFCHAIN_QT_SENDTOKENSENTRY_H
