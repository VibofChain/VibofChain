...
#ifndef VIBOFCHAIN_SCRIPT_STANDARD_H
#define VIBOFCHAIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a vibofchain address
 */
...
/**
 * Generate a VibofChain scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // VIBOFCHAIN_SCRIPT_STANDARD_H
